...
Racket::Racket(Color &inner_color, Color &outer_color, double &racket_width_percentage) : Rectangle{inner_color, outer_color}, racket_width_percentage_(racket_width_percentage) {}
